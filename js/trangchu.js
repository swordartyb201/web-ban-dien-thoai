window.onload = function () {
	...
	var company = ["apple.png", "samsung.png", "oppo.png", "nokia.png", "xiaomi.png",
		"realme.png", "vivo.png", "mobell.png", "masstel.png", "itel.png"
	];
	...
	if (filters.length) { // có filter
		...
		addKhungSanPham('NỔI BẬT NHẤT', yellow_red, ['star=4', 'sort=rateCount-decrease'], soLuong, div);
		...
		addKhungSanPham('GIÁ SỐC ONLINE', green, ['promo=giasoconline', 'sort=rateCount-decrease'], soLuong, div);
